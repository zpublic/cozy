#pragma once
/****
//商业推广组的需求比较奇特，所以对这些窗口的改动也很奇葩
//为了不影响其他工程的编译，特此复制一份出来修改
//来源自CBkDialogViewImplEx.h
//再次感谢原作者 贺旭军
****/
/*
2014-05-06 16:24:49 修改
CBkDialogViewImplEx 的 HitTest() 改为虚函数，方便做特殊修改
*/
...
public:
	virtual UINT HitTest(CPoint point)
	{
		CRect rcClient;
		CRect rcTest;
