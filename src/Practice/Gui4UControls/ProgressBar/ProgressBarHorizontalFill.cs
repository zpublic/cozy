// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ProgressBarHorizontalFill.cs" company="Jarno Burger">
//   See copyright.txt in the root of this project.
// </copyright>
// <summary>
//   Defines the ProgressBarHorizontalFill type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace GUI4UControls.ProgressBar
{
    ...
    /// </summary>
    public class ProgressBarHorizontalFill : Control
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProgressBarHorizontalFill"/> class.
        /// </summary>
        /// <param name="name">The name.</param>
        public ProgressBarHorizontalFill(string name) : base(name)
        {
        }
        ...
        private void Redraw()
        {
            ...
            var maxBarLength = (int)Config.Width;

            var barLength = modPercentage * maxBarLength;
